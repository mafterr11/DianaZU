...
function ProjectCard({ imageUrl, title, description }: IProps) {
  return (
    <div className="rounded-[14px] px-[5px] transition-all duration-500 ease-in-out hover:-translate-y-2">
      <div className="bg-[#FFEBDB] px-[27px] py-4 xl:h-[500px] xl:w-[420px]">
        <Image width={800} height={800} src={imageUrl} alt="service icon" className="w-full h-full object-contain" />
      </div>
